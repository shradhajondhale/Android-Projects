...
public class MyAreaPage extends ActionBarActivity {
...
//	TextView prev_votes;
	TextView district_name, districtnameongraph;
    ...
    int weekofyear;
    String get_phone_number_s, weekdata_s, yeardata_s, constituency_s;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_my_area_page);
		...
		StrictMode.enableDefaults();
		 ...
		 flippy =(ViewFlipper)findViewById(R.id.viewFlipper1);
		    ...
		    Cursor c2 = db.rawQuery("SELECT * FROM ad WHERE id='"+1+"'", null);
			if(c2.getCount() == 0)
			{
			   return;
			}
			...
			//Toast.makeText(getApplicationContext(), " "+c1.getString(1) , Toast.LENGTH_SHORT).show();
		    ...
		    View content = findViewById(R.id.graphlayoutdistrict);
        ...
        district_name = (TextView)findViewById(R.id.title);
        districtnameongraph = (TextView)findViewById(R.id.subtitle);
		...
		while( c1.moveToNext() ){
			constituency_s = c1.getString(3);
			//Toast.makeText(getApplicationContext(), "Constituency "+c1.getString(3) , Toast.LENGTH_SHORT).show();
		  
		}
		district_name.setText("" + constituency_s);
		districtnameongraph.setText("#" + constituency_s);
...
//Toast.makeText(getApplicationContext(), ""+weekcheck, Toast.LENGTH_SHORT).show();
		...
		if( isInternetPresent == false ){
			...
			//Toast.makeText(getApplicationContext(), "connect to internet", Toast.LENGTH_SHORT).show();
			 AlertDialog.Builder builder = new AlertDialog.Builder(MyAreaPage.this);
	       builder.setMessage("No Internet Connection");
	        ...
	        builder.setPositiveButton("OK",
				...
				public void onClick(DialogInterface dialog,int which) {
					...
					/*
					 Intent intent = new Intent(getApplicationContext(), MyAreaPage.class);
	...
	//async task for getall
		 public class GetAll extends AsyncTask <Void, Void, Void>{
	     	...
	     	ProgressDialog dialog = new ProgressDialog(MyAreaPage.this);
			  ...
			  dialog.show();
	   	    ...
	   	    protected Void doInBackground(Void... params) {
				...
				try{
				  ...
				  HttpPost httppost = new HttpPost("http://www.spmaverick.com/AssamPoll/REFRESH_WEEK.php"); //YOUR PHP SCRIPT ADDRESS
	   	 ...
	   	 protected void onPostExecute(Void unused) {
	   		//Toast.makeText(getApplicationContext(), "weeknumber " + week_number_s1 , Toast.LENGTH_SHORT).show();
	         dialog.dismiss();
		...
		//async task for getinfo
				  ...
				  dialog.show();
		   	    ...
		   	    protected Void doInBackground(Void... params) {
					...
					try{
					  ...
					  HttpPost httppost = new HttpPost("http://www.spmaverick.com/AssamPoll/CHANGE_VOTE_WEEK.php"); //YOUR PHP SCRIPT ADDRESS
		     ...
		     */
	               ...
	               LayoutInflater inflater = getLayoutInflater();
			        ...
			        //Set text
			        TextView text = (TextView) layout.findViewById(R.id.tv);
			        text.setText("Failed to change vote!");
			 ...
			 public class GetAllRefresh extends AsyncTask <Void, Void, Void>{
			        ...
			        // dialog.dismiss();
					 ...
					 try{
			      	 ...
			      	 isr.close();
			      	 result = sb.toString();
			     	//Toast.makeText(getApplicationContext(), "weeknumber " + result , Toast.LENGTH_SHORT).show();
 ...
 public void votecon(View v){
		 ...
		 if(weekcheck == 0){
		  ...
		  AlertDialog.Builder alertDialog = new  AlertDialog.Builder(MyAreaPage.this);
		...
		if(checknet()==0){
		 ...
		 if(check_present_vote == 1){
			 ...
			 //flippy.stopFlipping();
    	      ...
    	      alertDialog.setMessage("Are you sure you want to vote for Congress ?");     
     ...
     check_week();
		 ...
		 if(checknet()==0){
   	      ...
   	      alertDialog.setTitle("Confirm Vote");
   	      alertDialog.setIcon(R.drawable.confirm);
   	      alertDialog.setMessage("Are you sure you want to vote for Bharatiya Janata Party ?");     
   	      alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
       ...
       if(check_present_vote == 3){
    	   ...
    	   LayoutInflater inflater = getLayoutInflater();
	        ...
	        toast.show();		 }else{
   	      ...
   	      alertDialog.setTitle("Confirm Vote");
   	      alertDialog.setIcon(R.drawable.confirm);
   	      alertDialog.setMessage("Are you sure you want to vote for Aam Aadmi Party ?");     
   	      alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
 ...
 check_week();
		 ...
		 if(check_present_vote == 4){
   	      ...
   	      alertDialog.setTitle("Confirm Vote");
   	      alertDialog.setIcon(R.drawable.confirm);
   	      alertDialog.setMessage("Are you sure you want to vote for Assam Gana Parishad ?");     
   	      alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
 ...
 check_week();
		 ...
		 if(check_present_vote == 5){
   	      ...
   	      alertDialog.setTitle("Confirm Vote");
   	      alertDialog.setIcon(R.drawable.confirm);
   	      alertDialog.setMessage("Are you sure you want to vote for All India United Democratic Front ?");     
   	      alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
 ...
 check_week();
		 ...
		 if(checknet()==0){
            ...
            if(check_present_vote == 6){
   	      ...
   	      alertDialog.setTitle("Confirm Vote");
   	      alertDialog.setIcon(R.drawable.confirm);
   	      alertDialog.setMessage("Are you sure you want to vote for Other Parties ?");     
   	      alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
   ...
   private final Runnable m_Runnable = new Runnable()
   {
...

	      {
	    	...
	    	MyAreaPage.this.mHandler.postDelayed(m_Runnable, 60000); 
   ...
   public void onBackPressed() {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.my_area_page, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		//	new GetInfo(get_phone_number_s).execute();
			return true;
		}
          if (id == R.id.more) {
